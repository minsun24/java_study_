...
public class Application1 {
    public static void main(String[] args) {
        ...
        System.out.println("CPU 코어 수 : " + coreCount);  // 8개
...
//        stringList.stream().forEach(x -> Application1.print(x));
        stringList.forEach(x -> Application1.print(x)); // 필기. 컬렉션은 stream()을 생략해도 된다.
        System.out.println();


        /* 설명. main 쓰레드 상에서 병렬 스트림을 사용하고 확인 (cpu 코어 병렬 처리) */
        System.out.println("===== parallel stream");    // cpu 코어들을 효율적으로 사용해 성능 향상(속도 향상)
