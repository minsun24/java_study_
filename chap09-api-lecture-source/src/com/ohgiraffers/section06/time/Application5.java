...
public class Application5 {
    public static void main(String[] args) {
        ...
        LocalTime localTime = LocalTime.parse(timeNow);     // 문자열을 (:) 구분자로 자동 파싱해서 LocalTime형으로 인식
        LocalDate localDate = LocalDate.parse(dateNow);     // 문자열을 (-) 구분자로 자동 파싱해서 LocalDate형으로 인식
...
//        localDateTime = 2025-02-05T15:10:10
//        localDate = 2025-02-05
//        localDateTime = 2025-02-05T15:10:10
//        localTime2= 15:14:14
//        localDate2= 2025-02-05


        /* 설명. time패키지에서 인식한 날짜 및 시간을 우리가 원하는 패턴의 문자열로 반환하기 */
